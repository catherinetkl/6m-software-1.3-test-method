...
|Performance Test|5|3 sentences max|
|Security Test|5, 6, 7|3 sentences max|
...
|The Test|When? (SDLC)|How are they performed?|
|----|----|---|
|Security Test|5,6 and 7|It can be done with automation, engage testing companies, or AI|
